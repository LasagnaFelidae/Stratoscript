...
( function () {
    ...
    function modeDiscret() {
        ...
        if (logoImage) {
            ...
            logoImage.src = 'https://i.imgur.com/Z1PJ3xX.png';
        ...
        avatarImages.forEach(function(img) {
            ...
            img.src = 'https://i.imgur.com/xLpz2MP.png';
    ...
    formGroups.forEach(formGroup => {
        ...
        catboxLogo.width = 15;
        if (parametres ["sw-litter-toggle"]==false){
        catboxLogo.src = 'https://i.imgur.com/hvl7OlI.png';
        } else{
        catboxLogo.src = 'https://i.imgur.com/D0bAQqr.png';
        }
   ...
   // Function to add Imgur button and dropzone
    ...
    formGroups.forEach(formGroup => {
        ...
        imgurLogo.width = 15;
        imgurLogo.src = 'https://i.imgur.com/5XGih4k.png';
...
function addNoelshackButton() {
    ...
    formGroups.forEach(formGroup => {
        ...
        noelshackLogo.src = 'https://i.imgur.com/ZYm507L.png'; // Replace with the actual path to the Noelshack logo
...
async function appliquer_blacklist_posts(page) {
    ...
    function creerPannelStratoscript() {
        ...
        boutonScript.innerHTML = '<a style="height:70px;width:55px" class="btnStratoscript" data-toggle="modal" data-target="#modalStratoscript" href="#stratoscriptPanel" ><img class="btnStratoscript" style="position:absolute" target="_blank" src="https://i.imgur.com/DJlmlib.png" alt="Stratoscript" height="24"></a>';
        ...
        fetch(rawScriptUrl)
            ...
            if (rawScriptVersion && !compareVersions(installedVersion, rawScriptVersion)) {
                ...
                boutonAlerte.innerHTML = '<a style="height:70px;width:55px" class="btn-ss-update" href="https://raw.githubusercontent.com/TabbyGarf/Stratoscript/main/stratoscript.user.js" ><img class="btnUpdate" style="position:absolute" target="_blank" src="https://i.imgur.com/rA0hKoE.png" alt="!!!" title="Une mise à jour est disponible !" height="24"></a>';
